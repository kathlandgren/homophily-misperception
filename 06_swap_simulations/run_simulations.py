...
if __name__ == "__main__":
    output_dir = here() / "06_swap_simulations" / "output"
    ...
    with ProcessPoolExecutor(max_workers=75) as executor:
        futures = [
            executor.submit(fun.run_simulation_wrapper_with_swaps,
                            (homophily, m, num_agents, num_sim,
                             int(minority_fraction * num_agents), minority_fraction))
